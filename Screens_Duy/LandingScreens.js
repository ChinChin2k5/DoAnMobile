...
const featuresData = [
  { id: 1,
   ...
   desc: 'Công cụ tạo đề thi trực quan với ngân hàng câu hỏi', 
   icon: BookOpen, 
   color: '#3b82f6', 
   bg: '#eff6ff' },
  { id: 2,
   title: 'Thi trực tuyến', 
   desc: 'Tổ chức kỳ thi trực tuyến an toàn với giám sát tự động', 
   icon: Laptop, 
   color: '#10b981', 
   bg: '#ecfdf5' },
  { id: 3, 
  title: 'Báo cáo chi tiết', 
  desc: 'Phân tích kết quả thi với biểu đồ trực quan', 
  icon: BarChart2, 
  color: '#8b5cf6', 
  bg: '#f5f3ff' },
  { id: 4, 
  title: 'Bảo mật cao', 
  desc: 'Hệ thống bảo mật đa lớp đảm bảo an toàn thông tin', 
  icon: ShieldCheck, 
  color: '#ef4444', 
  bg: '#fef2f2' },
  { id: 5, 
  title: 'Chấm điểm tự động', 
  desc: 'Chấm điểm nhanh chóng với thuật toán thông minh', 
  icon: Zap, 
  color: '#f59e0b', 
  bg: '#fffbeb' },
  { id: 6, 
  title: 'Quản lý người dùng', 
  desc: 'Quản lý thí sinh, giáo viên và phân quyền linh hoạt', 
  icon: Users, 
  color: '#3b82f6', 
  bg: '#eff6ff' },
];
