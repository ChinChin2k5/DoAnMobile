        ...
        <SafeAreaView style={styles.container}>
            ...
            {isLoading ? (
                <View style={styles.center}>
                    <Text style={{ color: '#64748b' }}>Đang tải dữ liệu...</Text>
                </View>
...
const styles = StyleSheet.create({
    container: { flex: 1, backgroundColor: '#f8fafc',paddingBottom:60 },
    header: { padding: 16, backgroundColor: 'white', elevation: 2, alignItems: 'center' },
    headerTitle: { fontSize: 18, fontWeight: 'bold', color: '#0f172a' },
    center: { flex: 1, justifyContent: 'center', alignItems: 'center' },
    emptyText: { marginTop: 10, color: '#64748b', fontSize: 14, textAlign: 'center', paddingHorizontal: 32 },
    ...
    detailBtn: { paddingVertical: 8, paddingHorizontal: 12, backgroundColor: '#eff6ff', borderRadius: 8, justifyContent: 'center', alignItems: 'center', width: '100%', alignSelf: 'center', marginTop: 10 },
